...
(function () {
  ...
  var TA = {
    ...
    /* contact */
    "contact.title": "வணக்கம் சொல்லுங்கள்.",
    "contact.intro": "மின்னஞ்சல் என்னை அடைய வேகமான வழி — அல்லது இணையத்தில் சிதறிக் கிடக்கும் இடங்களில் என்னைக் கண்டுபிடியுங்கள்.",

    /* talks / blog */
    "talks.filterAria": "வடிகட்டி",
    "talks.likeAria": "விருப்பம்",

    /* credits */
    "credits.head": "நன்றி",
    "credits.velour": "இந்த தளத்தின் சித்திரங்கள் இந்த கணக்கிலிருந்து உத்வேகம் பெற்றவை",
    "credits.warren": "அவர்களின் 寒蝉手拙体 எழுத்துரு புதிய சீன தழுவலில் பயன்படுத்தப்பட்டுள்ளது"
  };
